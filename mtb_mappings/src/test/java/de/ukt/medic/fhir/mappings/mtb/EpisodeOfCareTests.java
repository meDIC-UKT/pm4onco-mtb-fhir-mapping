...
public class EpisodeOfCareTests {
    ...
    @Test
    public void testEpisodeOfCareMapping(){

        var episodesOfCare = patientRecord.episodesOfCare();

        System.out.println("=== DNPM episodesOfCare ===");
        System.out.println(episodesOfCare);
        System.out.println();

        // todo: test DNPM episodesOfCare to FHIR
